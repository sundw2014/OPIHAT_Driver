...
void set_motor_speed(int motor_ID, int16_t speed){
  ...
  switch(motor_ID){
    case 1:
      ...
      __HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_4, ABS(speed));
      break;
    case 2:
      ...
      break;
    case 3:
      HAL_GPIO_WritePin(GPIOC, GPIO_PIN_0, IN1);
      HAL_GPIO_WritePin(GPIOC, GPIO_PIN_1, IN2);
      __HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_1, ABS(speed));
      break;
    case 4:
